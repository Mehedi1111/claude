...
export default function BeforeAfter({
  ...
  return (
    <div className="not-prose my-10">
      <div
        ref={ref}
        className="relative aspect-[16/9] overflow-hidden cursor-col-resize select-none bg-[#e5e5e5] rounded-sm"
      ...
      >
        ...
        {/* Divider */}
        <div className="absolute top-0 bottom-0 w-px bg-[#0a0a0a] z-10" style={{ left: `${pos}%` }}>
          <div className="absolute top-1/2 -translate-x-1/2 -translate-y-1/2 w-9 h-9 bg-[#0a0a0a] rounded-full flex items-center justify-center shadow-lg cursor-grab active:cursor-grabbing">
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              <path d="M4 2L1 7L4 12M10 2L13 7L10 12" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>

        {/* Corner labels */}
        <span className="absolute bottom-3 left-3 text-[10px] font-sans font-bold text-[#737373] uppercase tracking-[0.15em] z-10">
          {beforeLabel}
        </span>
        <span className="absolute bottom-3 right-3 text-[10px] font-sans font-bold text-[#737373] uppercase tracking-[0.15em] z-10">
          {afterLabel}
        </span>
      </div>
