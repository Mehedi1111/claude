...
Open the SVG your designer delivered in a code editor. If you're not sure what format you even need, start with [logo file formats explained](/blog/logo-file-formats-explained). If it looks like this, you have a problem:
...
A well-optimized logo SVG is 1–3KB. A raw Illustrator export of the same mark can be 20–80KB. For the [Jowa brand identity project](/portfolio/jowa), we delivered a 1.2KB SVG with a React component — down from a 28KB Illustrator export., depending on the version of Illustrator and the export settings used.
...
For React applications, converting the SVG to a typed component gives developers clean, flexible integration. This is included as standard in our [SVG Conversion service](/services/svg-conversion):
