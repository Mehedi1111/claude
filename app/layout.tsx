  ...
  return (
    ...
    >
      ...
      <body className="antialiased">
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[9999] focus:bg-white focus:text-[#0a0a0a] focus:px-4 focus:py-2 focus:text-sm focus:font-sans focus:font-semibold focus:border focus:border-[#0a0a0a]"
        >
