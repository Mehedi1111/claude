...
export const portfolioItems = [
  {
    ...
    challenge: "Nexus AI had a compelling Midjourney-generated logo that had resonated with the founding team. But as the company approached Series A, it became clear the mark was technically unusable — blurry at print scale, lacking proper CMYK values, and with no vector source file to hand to vendors.",
    solution: "We conducted a full path-level reconstruction. The geometric octagonal form was rebuilt using mathematical proportions derived from the original raster, ensuring the core character of the mark was preserved while delivering flawless technical integrity.",
    outcomes: ["Delivered in under 36 hours", "Full brand system from single mark", "Print-ready at any scale"],
  ...
  },
  {
    ...
    challenge: "Forma Studio's AI-generated wordmark featured beautiful display letterforms — but they were rasterised, optically unbalanced, and impossible to reproduce consistently. The kerning was irregular, certain characters had merged, and the tracking didn't survive at display scale.",
    solution: "Each character was rebuilt as a custom vector path. We identified the likely source typeface family, then made systematic optical corrections to spacing, weight consistency, and baseline alignment. The result was a wordmark that looked hand-crafted rather than generated.",
    outcomes: ["Consistent rendering at all sizes", "Editable source files for future updates", "Type specimen sheet delivered"],
  ...
  },
  {
    ...
    challenge: "Arc Commerce had outgrown their informal brand approach. A DALL-E generated logo had served as a placeholder, but with a Series A raise complete and a rebrand in motion, they needed a complete visual system their growing design team could operate from.",
    solution: "Starting from the vectorised DALL-E mark, we extended the geometry into a full brand system: a 4-colour palette with all print and digital values, a 3-level typography hierarchy, spacing rules, and a 40-page brand guidelines document designed to be handed to any new designer.",
    outcomes: ["40-page brand guidelines", "Complete asset library for design team", "On-brand stationery suite ready for print"],
  ...
  },
  {
    ...
    year: "2025",
    tags: ["SVG", "Web-Ready"],
    challenge: "Volt SaaS needed their logo integrated across a complex React codebase. The exported SVG was over 14KB, contained hundreds of redundant nodes, used inline styles incompatible with theming, and was structured in a way that made animation impossible.",
    solution: "We rebuilt the SVG from scratch — 2.1KB, clean IDs, no inline styles, CSS variable support for dark/light mode theming, and an animation-ready layer structure. We delivered a typed React component with a full prop interface for size and colour control.",
    outcomes: ["SVG reduced from 14KB to 2.1KB", "Full React component with TypeScript types", "Dark/light mode ready out of the box"],
  ...
  },
  {
    ...
    challenge: "Meridian Health had an AI-generated mark that their print vendor had rejected twice. The paths had open endpoints, the stroke weights were inconsistent across components, and the intended 'brand blue' had shifted to purple under CMYK conversion.",
    solution: "Full technical audit of the file structure. We closed open paths, converted strokes to outlines, standardised element weights, and performed rigorous CMYK colour management to match the intended brand blue precisely across both coated and uncoated stock.",
    outcomes: ["Print vendor accepted first submission", "Pantone values matched and documented", "Full file structure audit report delivered"],
  ...
  },
  {
    ...
    challenge: "Parallel Labs was building cutting-edge research infrastructure at the intersection of quantum computing and machine learning. They needed a mark that conveyed mathematical rigour, precision, and the concept of parallel processing — without resorting to generic tech iconography.",
    solution: "We designed a custom geometric mark derived from a mathematical grid system — two offset parallelogram forms that create a negative space P when overlapped. The mark is built on a 12-unit grid with all proportions derived from the golden ratio. No AI tools were used at any stage.",
    outcomes: ["3 concept directions delivered", "Final mark selected in round 1 refinement", "Full brand identity system included"],
    service: "Logo Design",
  },
];
